...
const AnimationVideoBlock = ({ product }: Props) => {
  return (
    <section
      ...
      <div className="mt-8 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-6xl aspect-video ">
          <iframe
            ...
            src={`https://www.youtube.com/embed/${product.acf.animation_youtube_id}`}
...
export default AnimationVideoBlock;
